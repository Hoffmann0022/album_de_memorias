...
export function Sticker({ id, image, date, place, isVisible, onClick }: Card) {
    return (
        <>
            {
                isVisible ? (
                    <div key={id} onClick={onClick} className='flex flex-col justify-center items-start gap-5 py-5 px-5 bg-card rounded-xs shadow-polaroid cursor-pointer lg:hover:scale-103 transition-all duration-400'>
